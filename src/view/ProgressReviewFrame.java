...
public class ProgressReviewFrame extends JFrame {
    ...
    private JPanel buildLogTab() {
        ...
        Theme.constrainComboWidth(groupCombo, Theme.FORM_FIELD_WIDTH + 80);
        topPanel.add(groupCombo);
        panel.add(topPanel, BorderLayout.NORTH);

        logListModel = new DefaultListModel<>();
        logList = new JList<>(logListModel);
        Theme.styleList(logList);
        ...
        Theme.styleTextArea(feedbackArea);
    ...
    private JPanel buildDocumentTab() {
        ...
        Theme.styleComboBox(docGroupCombo);
        Theme.constrainComboWidth(docGroupCombo, Theme.FORM_FIELD_WIDTH + 80);
        ...
        Theme.styleTextArea(docFeedbackArea);
