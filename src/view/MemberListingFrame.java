...
public class MemberListingFrame extends JFrame {
    ...
    public MemberListingFrame(Student student) {
        ...
        Theme.constrainFormFieldWidth(skillsField, Theme.FORM_FIELD_WIDTH + 100);
        ...
        if (student != null) {
            ...
            createPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Theme.BORDER), "Post a New Listing", 0, 0, Theme.BOLD_FONT, Theme.TEXT));
            ...
            Theme.styleTextArea(descriptionArea);
            JScrollPane descriptionScroll = new JScrollPane(descriptionArea);
            Theme.styleScrollPane(descriptionScroll);
            descriptionScroll.setBorder(BorderFactory.createLineBorder(Theme.BORDER, 1));
        ...
        add(mainPanel);
        pack();
        setMinimumSize(new Dimension(680, student != null ? 620 : 520));
    }
