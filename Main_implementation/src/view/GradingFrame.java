...
public class GradingFrame extends JFrame {
    ...
    public GradingFrame(Supervisor supervisor) {
        ...
        Theme.styleTextArea(rubricArea);
        rubricArea.setFont(Theme.MONO_FONT);
        loadRubric();
        JScrollPane rubricScroll = new JScrollPane(rubricArea);
        Theme.styleScrollPane(rubricScroll);
        rubricScroll.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Theme.BORDER), "Reference Rubric", 0, 0, Theme.BOLD_FONT, Theme.TEXT));
        rubricScroll.setPreferredSize(new Dimension(560, 160));
        ...
        Theme.constrainComboWidth(studentCombo, Theme.FORM_FIELD_WIDTH);
        ...
        Theme.styleSpinner(marksSpinner);
        Theme.constrainSpinnerWidth(marksSpinner, 140);
        form.add(marksSpinner);

        body.add(Theme.wrapCentered(form), BorderLayout.CENTER);
